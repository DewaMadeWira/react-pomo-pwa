    ...
    return (
        <ThemeContext.Provider value={theme}>
            <div
                className={`${
                    theme.theme == 'light'
                        ? 'bg-white-bg text-dark-text-bg'
                        : 'bg-dark-text-bg text-white-bg'
            ...
            >
                <div className='h-[10vh] flex justify-end px-7 pt-2'>
                    <img
                        ...
                        className='w-12 hover:cursor-pointer hover:-translate-y-1 transition-all'
                        alt='dark mode button'
                    />
                </div>
                <div className='flex px-5 md:px-0 flex-col justify-around items-center h-[90vh]'>
                    <div className=''>
                        <h1 className='text-5xl text-center font-mont text-inherit font-bold'>
                            Pomodoro Timer
                        </h1>
                    </div>
                    ...
                    >
                        <TimerComponent
                            callbackTimer={setRemainingTime}
                        ></TimerComponent>
                        <ButtonContainer
                            screenWidth={screenSize.width}
                        ></ButtonContainer>
                    </TimerContext.Provider>
                    <footer className='font-hind text-lg hover:-translate-y-2 transition-all text-center'>
                        <a
                            href='https://www.flaticon.com/free-icons/stopwatch'
                            title='stopwatch icons'
                        >
                            Stopwatch icons created by{' '}
                            <span className='font-bold'>monkik - Flaticon</span>
                        </a>
                    </footer>
                </div>
            </div>
